...
@Component({
  selector: 'app-demo-object-creation',
  templateUrl: './demo-object-creation.component.html',
  styleUrls: ['./demo-object-creation.component.scss']
})
export class DemoObjectCreationComponent implements OnInit {
